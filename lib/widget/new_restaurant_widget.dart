...
class NewRestaurant extends GetView<BeatRestaurantController> {
  const NewRestaurant({super.key});
        ...
        SizedBox(
          ...
          child: Obx(() => ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  Reastaurant restaurant = controller.newList[index];
                  return Container(
                    margin: EdgeInsets.only(
                      right:
                      controller.newList.first.id == restaurant.id ? 0 : 5,
                      left:
                      controller.newList.last.id == restaurant.id ? 0 : 5,
                    ),
                    child: InkWell(
